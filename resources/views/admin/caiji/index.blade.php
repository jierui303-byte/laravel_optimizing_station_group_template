            ...
            <div class="result_content">
                <table class="list_tab">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="https://www.baidu.com/s?wd=https://jierui303.com/cate/{{$v->cate_id}}">{{$v->_cate_name}}</a>
                        </td>
                        <td>{{$v->cate_title}}</td>
                        <td>{{$v->cate_view}}</td>
                        <td>
                            ...
                            <a href="javascript:;" onclick="delCate({{$v->cate_id}})">运行</a>
                        </td>
                    </tr>
                    @endforeach
