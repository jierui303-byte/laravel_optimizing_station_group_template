        ...
        <form action="{{url('admin/category/'.$field->cate_id)}}" method="post">
            ...
            <table class="add_tab">
                            ...
                            @foreach($data as $d)
                                @if($d->cate_pid == 0)
                                    ...
                                    @if($d->cate_id == $field->cate_pid)
                                        {{--判断是否ID是否一致--}}
                                        <option value="{{$d->cate_id}}" selected disabled>{{$d->cate_name}}</option>
                                    @else
                                        <option value="{{$d->cate_id}}" disabled>{{$d->cate_name}}</option>
                                    @endif
                                @else
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="cate_name" onchange="getPinYin(this,this.value)" value="{{$field->cate_name}}">
                ...
                <tr>
                    <th>栏目缩写：</th>
                    <td>
                        <input type="text" name="cate_suoxie" value="{{$field->cate_suoxie}}">
                    </td>
                </tr>
                <tr>
                    <th>栏目属性：</th>
                ...
                <tr>
                    <th>栏目路径：</th>
                    <td>
                        <input type="text" class="lg" name="cate_path" value="{{$field->cate_path}}">
                    </td>
                </tr>
                <tr>
                    <th>栏目SEO标题：</th>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" name="cate_content" value="{{$field->cate_content}}" type="text/plain" style="width:860px;height:500px;"></script>
