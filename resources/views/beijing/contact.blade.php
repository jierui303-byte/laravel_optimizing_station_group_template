...
<div class="container">
    ...
    <div class="right">
        <div class="righta">
            <h3>联系我们</h3>
            <span>您的位置：<a href="http://www.bjlengku.cn/">网站首页</a> - <a href="http://www.bjlengku.cn/index.php?m=content&amp;c=index&amp;a=lists&amp;catid=22">联系我们</a></span>
        </div>        <div class="rightb">
            <div class="rightc">
                <p>公司所在地：北京市-市辖区-昌平区<br>
                    经营地址：东小口镇半截塔村<br>
                    邮政编码：100076<br>
                ...
                <div style="text-align:center;width:700px;">
                    <iframe marginwidth="0" name="map_frame" scrolling="no" frameborder="0" src="./contact_files/map.html" style="width: 100%; height: 550px;"></iframe>
                </div>
            </div>
        </div>
    </div>
